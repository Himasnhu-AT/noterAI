...
function Usecases() {
  return (
    <div>
      <h1 className='text-2xl md:text-4xl lg:text-5xl font-semibold text-center mt-10'>Comprehensive underneath,</h1>
      <h1 className='text-2xl md:text-4xl lg:text-5xl font-semibold text-center mt-3'>simple on the surface</h1>
